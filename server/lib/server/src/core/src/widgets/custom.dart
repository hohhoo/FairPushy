...
class Json extends SenderWidget {
  ...
  Widget build(BuildContext context) {
    var data = content;
    try {
      data = content is Map ? content : content.toJson();
...
class Success extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var json = Json(data);
    Logger.root.info(jsonEncode(json.content));
    return json;
  }
}
...
class Error extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var json = Json(ResponseBaseModel(msg: error,  code: -1, data: null));
    Logger.root.shout(jsonEncode(json.content));
    return json;
  }
}
